<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp64\www\webthink\public/../application/admin\view\article\store.html";i:1496718790;s:65:"D:\wamp64\www\webthink\public/../application/admin\view\base.html";i:1496372119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form role="form" action="" method="post">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <label>
                    <input type="checkbox" name="tag[]" class="minimal" value="<?php echo $vo['tag_id']; ?>">
