<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wamp64\www\webthink\public/../application/admin\view\link\index.html";i:1496368510;s:65:"D:\wamp64\www\webthink\public/../application/admin\view\base.html";i:1496372119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="<?php echo url('store',['link_id'=>$vo['link_id']]); ?>" class="btn btn-primary">修改</a>
                    <a href="#" class="btn btn-danger" onclick="del(<?php echo $vo['link_id']; ?>)">删除</a>
                </td>
            </tr>
