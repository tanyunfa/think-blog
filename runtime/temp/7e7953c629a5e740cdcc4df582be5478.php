<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp64\www\webthink\public/../application/admin\view\article\index.html";i:1496299646;s:65:"D:\wamp64\www\webthink\public/../application/admin\view\base.html";i:1496372119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function del(arc_id) {
        layer.confirm('确认删除？', {
            ...
            location.href = "<?php echo url('delToRecyle'); ?>" + '?arc_id=' + arc_id;
        });
    }
</script>
