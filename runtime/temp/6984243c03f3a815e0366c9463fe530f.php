<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\webthink\public/../application/admin\view\category\index.html";i:1496301469;s:65:"D:\wamp64\www\webthink\public/../application/admin\view\base.html";i:1496372119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .layui-layer-btn .layui-layer-btn1 {
            ...
            background-color: #4898d5 !important;
            color: #fff !important;
        }
    </style>
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="<?php echo url('addSon',['cate_id'=>$vo['cate_id']]); ?>" class="btn btn-primary">添加子栏目</a>
                    <a href="<?php echo url('edit',['cate_id'=>$vo['cate_id']]); ?>" class="btn btn-primary">修改</a>
                    <a href="#" class="btn btn-danger" onclick="del(<?php echo $vo['cate_id']; ?>)">删除</a>
                </td>
            </tr>
