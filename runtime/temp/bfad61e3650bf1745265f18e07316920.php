<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wamp64\www\webthink\public/../application/admin\view\tag\index.html";i:1496301513;s:65:"D:\wamp64\www\webthink\public/../application/admin\view\base.html";i:1496372119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="<?php echo url('store',['tag_id'=>$vo['tag_id']]); ?>" class="btn btn-primary">修改</a>
                    <a href="#" class="btn btn-danger" onclick="del(<?php echo $vo['tag_id']; ?>)">删除</a>
                </td>
            </tr>
